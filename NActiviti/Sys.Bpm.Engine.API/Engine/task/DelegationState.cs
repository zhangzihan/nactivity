...
namespace Sys.Workflow.Engine.Tasks
{
	...
	public enum DelegationState
	{
	  ...
	  /// <summary>
	  /// The owner delegated the task and wants to review the result after the assignee has resolved the task. When the assignee completes the task, the task is marked as <seealso cref="#RESOLVED"/> and sent back
