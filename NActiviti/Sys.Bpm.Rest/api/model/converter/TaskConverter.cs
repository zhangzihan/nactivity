...
using static org.activiti.cloud.services.api.model.Task;
...
{
    public class TaskConverter : ModelConverter<ITask, Task>
    {
        ...
        public virtual org.activiti.cloud.services.api.model.Task from(ITask source)
        {
        ...
        public virtual IList<Task> from(IList<ITask> tasks)
        {
