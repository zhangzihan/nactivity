...
namespace org.activiti.cloud.services.events
{
    ...
    public class TaskCancelledEventImpl : AbstractProcessEngineEvent
    {
        ...
        public TaskCancelledEventImpl(string appName, string appVersion, string serviceName, string serviceFullName, string serviceType, string serviceVersion, string executionId, string processDefinitionId, string processInstanceId, Task task) : base(appName, appVersion, serviceName, serviceFullName, serviceType, serviceVersion, executionId, processDefinitionId, processInstanceId)
        {
            this.task = task;
        }
