...
namespace org.activiti.cloud.services.events.converter
{
    public class VariableDeletedEventConveter : AbstractEventConverter
    {
        ...
        {
            return new VariableDeletedEventImpl(RuntimeBundleProperties.AppName, RuntimeBundleProperties.AppVersion, RuntimeBundleProperties.ServiceName, RuntimeBundleProperties.ServiceFullName, RuntimeBundleProperties.ServiceType, RuntimeBundleProperties.ServiceVersion, @event.ExecutionId, @event.ProcessDefinitionId, @event.ProcessInstanceId, ((ActivitiVariableEventImpl)@event).VariableName, ((ActivitiVariableEventImpl)@event).VariableType.TypeName, ((ActivitiVariableEventImpl)@event).TaskId);
        }
