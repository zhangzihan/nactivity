...
namespace org.activiti.cloud.services.events.converter
{
    public class ActivityStartedEventConverter : AbstractEventConverter
    {
        ...
        {
            return new ActivityStartedEventImpl(RuntimeBundleProperties.AppName, RuntimeBundleProperties.AppVersion, RuntimeBundleProperties.ServiceName, RuntimeBundleProperties.ServiceFullName, RuntimeBundleProperties.ServiceType, RuntimeBundleProperties.ServiceVersion, @event.ExecutionId, @event.ProcessDefinitionId, @event.ProcessInstanceId, ((ActivitiActivityEventImpl)@event).ActivityId, ((ActivitiActivityEventImpl)@event).ActivityName, ((ActivitiActivityEventImpl)@event).ActivityType);
        }
