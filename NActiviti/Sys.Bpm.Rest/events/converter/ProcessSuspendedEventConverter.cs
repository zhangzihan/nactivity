...
namespace org.activiti.cloud.services.events.converter
{
    public class ProcessSuspendedEventConverter : AbstractEventConverter
    {
        ...
        {
            return new ProcessSuspendedEventImpl(RuntimeBundleProperties.AppName, RuntimeBundleProperties.AppVersion, RuntimeBundleProperties.ServiceName, RuntimeBundleProperties.ServiceFullName, RuntimeBundleProperties.ServiceType, RuntimeBundleProperties.ServiceVersion, @event.ExecutionId, @event.ProcessDefinitionId, @event.ProcessInstanceId, processInstanceConverter.from(((ExecutionEntityImpl)((IActivitiEntityEvent)@event).Entity).ProcessInstance));
        }
