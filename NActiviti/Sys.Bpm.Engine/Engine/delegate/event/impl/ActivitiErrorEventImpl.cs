...
namespace Sys.Workflow.engine.@delegate.@event.impl
{
    ...
    /// <summary>
    /// Implementation of an <seealso cref="IActivitiErrorEvent"/>.
    /// 
    /// 
    /// </summary>
    public class ActivitiErrorEventImpl : ActivitiActivityEventImpl, IActivitiErrorEvent
    {

        protected internal string errorId;
