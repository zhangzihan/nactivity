...
namespace Sys.Workflow.engine.impl
{
    ...
    public class NativeHistoricActivityInstanceQueryImpl : AbstractNativeQuery<INativeHistoricActivityInstanceQuery, IHistoricActivityInstance>, INativeHistoricActivityInstanceQuery
    {
        ...
        public NativeHistoricActivityInstanceQueryImpl(ICommandContext commandContext) : base(commandContext)
        {
        }
        ...
        public override IList<IHistoricActivityInstance> ExecuteList(ICommandContext commandContext, IDictionary<string, object> parameterMap, int firstResult, int maxResults)
        {
