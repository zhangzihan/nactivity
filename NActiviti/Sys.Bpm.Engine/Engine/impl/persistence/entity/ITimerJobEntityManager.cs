...
namespace org.activiti.engine.impl.persistence.entity
{
	...
	public interface ITimerJobEntityManager : IEntityManager<ITimerJobEntity>
	{
	  ...
	  /// <summary>
	  /// Executes a <seealso cref="JobQueryImpl"/> and returns the matching <seealso cref="ITimerJobEntity"/> instances.
	  /// </summary>
	  IList<IJob> findJobsByQueryCriteria(TimerJobQueryImpl jobQuery, Page page);

	  /// <summary>
	  /// Same as <seealso cref="#findJobsByQueryCriteria(TimerJobQueryImpl, Page)"/>, but only returns a count 
