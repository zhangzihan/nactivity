...
namespace org.activiti.engine.impl.persistence.entity.data.impl.cachematcher
{
    ...
    public class IdentityLinksByProcInstMatcher : CachedEntityMatcherAdapter<IIdentityLinkEntity>
    {
        ...
        public override bool IsRetained(IIdentityLinkEntity entity, object parameter)
        {
            ...
            {
                return entity.ProcessInstanceId == parameter.ToString();
            }

            if (parameter is KeyValuePair<string, object> p)
            {
                return entity.ProcessInstanceId == p.Value?.ToString();
            }

            return entity.ProcessInstanceId == parameter.ToString();
            //return !string.ReferenceEquals(entity.ProcessInstanceId, null) && entity.ProcessInstanceId.Equals((string) parameter);
        }
