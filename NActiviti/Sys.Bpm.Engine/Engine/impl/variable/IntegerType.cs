...
{
    /// 
    public class IntegerType : AbstractVariableType
    {
        ...
        public override object GetValue(IValueFields valueFields)
        {
            ...
            {
                return (int?)valueFields.LongValue;
            }
            return null;
        }
        ...
        public override bool IsAbleToStore(object value)
        {
            ...
            return value.GetType().IsAssignableFrom(typeof(int)) || value.GetType().IsAssignableFrom(typeof(int));
        }
    }
