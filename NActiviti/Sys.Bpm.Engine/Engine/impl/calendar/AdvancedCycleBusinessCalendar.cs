    ...
    public class AdvancedCycleBusinessCalendar : CycleBusinessCalendar
    {
        ...
        public override DateTime? resolveDuedate(string duedateDescription, int maxIterations)
        {
            ...
            try
            {
                ...
                {
                    DateTime? date = rev.resolve(duedateDescription, clockReader, string.ReferenceEquals(timeZone, null) ? clockReader.CurrentTimeZone : TimeZone.CurrentTimeZone);//.FindSystemTimeZoneById(timeZone));
