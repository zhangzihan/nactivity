...
namespace Sys.Workflow.Engine.Impl.Agenda
{
    ...
    /// </para>
    /// </summary>
    public class ContinueProcessInCompensationOperation : AbstractOperation
    {
        private static readonly ILogger<ContinueProcessInCompensationOperation> log = ProcessEngineServiceProvider.LoggerService<ContinueProcessInCompensationOperation>();
        ...
        public ContinueProcessInCompensationOperation(ICommandContext commandContext, IExecutionEntity execution, bool forceSynchronousOperation, bool inCompensation) : base(commandContext, execution)
        {
        ...
        /// <param name="commandContext"></param>
        /// <param name="execution"></param>
        public ContinueProcessInCompensationOperation(ICommandContext commandContext, IExecutionEntity execution) : this(commandContext, execution, false, false)
        {
        }
