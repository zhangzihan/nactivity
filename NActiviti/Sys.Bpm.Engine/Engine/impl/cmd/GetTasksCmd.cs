...
namespace Sys.Workflow.Engine.Impl.Cmd
{
    ...
    /// </summary>
    [Serializable]
    public class GetTasksCmd : PageQueryCmd<ITaskQuery, ITask>
    {
        private const long serialVersionUID = 1L;

        public GetTasksCmd(IQuery<ITaskQuery, ITask> query, int firstResult, int pageSize) : base(query, firstResult, pageSize)
        {
        }
