...
namespace Sys.Workflow.engine.impl.cmd.integration
{
    ...
    public class DeleteIntegrationContextCmd : ICommand<IIntegrationContextEntity>
    {

        private IIntegrationContextEntity integrationContext;

        public DeleteIntegrationContextCmd(IIntegrationContextEntity integrationContext)
        {
