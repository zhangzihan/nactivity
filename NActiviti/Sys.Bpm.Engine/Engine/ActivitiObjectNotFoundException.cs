...
namespace Sys.Workflow.Engine
{
    ...
    public class ActivitiObjectNotFoundException : ActivitiException
    {
        ...
        protected ActivitiObjectNotFoundException(SerializationInfo serializationInfo, StreamingContext streamingContext) : base(serializationInfo, streamingContext)
        {
        }
    }
