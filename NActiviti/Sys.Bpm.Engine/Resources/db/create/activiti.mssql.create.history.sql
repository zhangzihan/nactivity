...
create index ACT_IDX_HI_COMMENT_TASK_ID on ACT_HI_COMMENT(TASK_ID_) INCLUDE(MESSAGE_);
create index ACT_IDX_HI_COMMENT_USER_ID on ACT_HI_COMMENT(USER_ID_) INCLUDE(MESSAGE_);
create index ACT_IDX_HI_COMMENT_PROC_INST_ID on ACT_HI_COMMENT(PROC_INST_ID_) INCLUDE(MESSAGE_);
