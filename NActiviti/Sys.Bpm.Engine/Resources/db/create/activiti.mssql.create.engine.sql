...
create index ACT_IDX_VARIABLE_NAME on ACT_RU_VARIABLE(NAME_);
...
create index ACT_IDX_RU_EXECUTION_START_USER_ID ON ACT_RU_EXECUTION(START_USER_ID_);
...
create index ACT_IDX_RU_SUSPENDED_JOB_TENANT_ID on ACT_RU_SUSPENDED_JOB(TENANT_ID_);
create index ACT_IDX_RU_TASK_TENANT_ID on ACT_RU_TASK(TENANT_ID_);
create index ACT_IDX_RU_TASK_ASSIGNEE on ACT_RU_TASK(ASSIGNEE_);
create index ACT_IDX_RU_TIMER_JOB_TENANT_ID on ACT_RU_TIMER_JOB(TENANT_ID_);
...
alter table ACT_RU_EXECUTION WITH NOCHECK
    add constraint ACT_FK_EXE_PARENT
    foreign key (PARENT_ID_) 
    references ACT_RU_EXECUTION (ID_);

alter table ACT_RU_EXECUTION NOCHECK CONSTRAINT ACT_FK_EXE_PARENT;
