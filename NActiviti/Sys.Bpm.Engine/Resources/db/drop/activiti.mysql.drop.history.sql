...
drop index ACT_IDX_HI_PROCINST_START_USER_ID on ACT_HI_PROCINST;
...
drop index ACT_IDX_HI_COMMENT_TASK_ID on ACT_HI_COMMENT;
drop index ACT_IDX_HI_COMMENT_USER_ID on ACT_HI_COMMENT;
drop index ACT_IDX_HI_COMMENT_PROC_INST_ID on ACT_HI_COMMENT;
drop index ACT_IDX_HI_TASKINST_PROC_INST_ID on ACT_HI_TASKINST;
drop index ACT_IDX_HI_TASKINST_ASSIGNEE on ACT_HI_TASKINST;
