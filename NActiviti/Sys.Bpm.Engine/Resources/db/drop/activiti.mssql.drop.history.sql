...
IF EXISTS (SELECT name FROM sysindexes WHERE name = 'ACT_IDX_HI_PROCINST_START_USER_ID') drop index ACT_HI_PROCINST.ACT_IDX_HI_PROCINST_START_USER_ID;
...
IF EXISTS (SELECT name FROM sysindexes WHERE name = 'ACT_IDX_HI_COMMENT_TASK_ID') drop index ACT_HI_COMMENT.ACT_IDX_HI_COMMENT_TASK_ID;
IF EXISTS (SELECT name FROM sysindexes WHERE name = 'ACT_IDX_HI_COMMENT_USER_ID') drop index ACT_HI_COMMENT.ACT_IDX_HI_COMMENT_USER_ID;
IF EXISTS (SELECT name FROM sysindexes WHERE name = 'ACT_IDX_HI_COMMENT_PROC_INST_ID') drop index ACT_HI_COMMENT.ACT_IDX_HI_COMMENT_PROC_INST_ID;
IF EXISTS (SELECT name FROM sysindexes WHERE name = 'ACT_IDX_HI_TASKINST_PROC_INST_ID') drop index ACT_HI_TASKINST.ACT_IDX_HI_TASKINST_PROC_INST_ID;
IF EXISTS (SELECT name FROM sysindexes WHERE name = 'ACT_IDX_HI_TASKINST_ASSIGNEE') drop index ACT_HI_TASKINST.ACT_IDX_HI_TASKINST_ASSIGNEE;
